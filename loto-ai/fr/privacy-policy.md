...
## 3. Traitement par des services tiers

L’Application peut transmettre certaines données (images, audio, texte) à des services tiers d’intelligence artificielle afin de fournir ses fonctionnalités.

Ces services traitent les données uniquement pour le compte du Prestataire de services et ne les utilisent pas à des fins publicitaires.

## 4. Partage des données

Les données ne sont pas vendues ni partagées avec des tiers à des fins commerciales.
...
Les données sont conservées aussi longtemps que nécessaire pour fournir le service et pour des raisons opérationnelles légitimes.

L’utilisateur peut demander la suppression de ses données en contactant le Prestataire de services.

## 6. Sécurité

Le Prestataire de services met en place des mesures techniques et organisationnelles raisonnables pour protéger les données contre l’accès non autorisé, la perte ou la divulgation.
...
L’Application n’est pas destinée aux personnes de moins de 13 ans et ne collecte pas sciemment de données auprès d’enfants.
...
Pour toute question concernant cette politique de confidentialité, vous pouvez contacter le Prestataire de services à :
[achats@intelligenceindustrielle.com](mailto:achats@intelligenceindustrielle.com)
